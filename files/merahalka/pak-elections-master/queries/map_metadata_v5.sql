...
SELECT year, party, party1, count(*) as seats 
FROM elections_v2
WHERE year = 1990 AND rvotes = 1
GROUP BY year, party, party1
ORDER BY seats DESC
LIMIT 100;

-- SELECT * FROM elections_v2
-- WHERE year = 1990 AND party = 'IJI' AND party1 = 137;

-- UPDATE elections_v2
-- SET party = 'PDA'
-- WHERE year = 1990 and id_no IN ('4028', '4686');

-- UPDATE elections_v2
-- SET party1 = 34
-- WHERE year = 1990 AND id_no = '5099'
-- ;

-- SELECT * FROM elections_v2
-- WHERE year = 1990 AND party = 'IND-F' AND party1 = 55;

-- UPDATE elections_v2
-- SET party = 'JUI(F)'
-- WHERE year = 1990 AND id_no = '5155';

-- SELECT * FROM elections_v2
-- WHERE year = 1990 AND party = 'PDA' AND party1 = 34;

-- UPDATE elections_v2
-- SET party = 'IJI'
-- WHERE year = 1990 AND id_no = '4687';

-- UPDATE elections_v2
-- SET party1 = 137
-- WHERE year = 1990 AND id_no = '5100';

-- SELECT * FROM elections_v2
-- WHERE year = 1990 AND party = 'INDEP' AND party1 = 30;

-- UPDATE elections_v2
-- SET party = 'HPG'
-- WHERE year = 1990 AND id_no = '5106';

-- SELECT * FROM elections_v2
-- WHERE year = 1990 AND party = 'PDA' AND party1 = 5;

-- UPDATE elections_v2
-- SET party = 'ANP'
-- WHERE year = 1990 AND id_no = '3884';

-- UPDATE elections_v2
-- SET party = 'JUI-F'
-- WHERE year = 1990 AND party = 'JUI(F)';

CREATE TABLE metadata_1990 AS
SELECT a.year, 'NA-'||a.na_value as na_number, a.na_value, a.na_name, candidate_name as winner, party as winner_party, 
runnerup, runnerup_party, diff_runner_up*100.0/total_votes as victory_margin, turn_out,
CASE WHEN party IN ('PDA', 'IJI', 'HPG', 'JUI-F','IND','ANP') THEN party ELSE 'Other' END as winner_party_cat,
CASE WHEN runnerup_party IN ('PDA', 'IJI', 'HPG', 'JUI-F','IND','ANP') THEN runnerup_party ELSE 'Other' END as runnerup_party_cat,
party1 as winner_party_num, runnerup_party_num
FROM public.elections_v2 a
LEFT JOIN (SELECT year, na_value, candidate_name as runnerup, party as runnerup_party, party1 as runnerup_party_num
          FROM public.elections_v2 WHERE year IN (1990) AND rvotes = 2) b
          ON a.year = b.year AND a.na_value = b.na_value
WHERE a.year IN (1990)
AND rvotes = 1
;
--204 rows
